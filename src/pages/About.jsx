                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[
                                ...
                                >
                                    ...
                                    <p className="text-gray-400 text-sm leading-relaxed font-normal italic">{item.text}</p>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-[#141414] border border-white/15 p-8 rounded-3xl text-center hover:border-primary/30 transition-colors">
                                ...
                                <p className="text-gray-300 font-normal italic text-sm leading-relaxed">{val.text}</p>
                            </div>
                        ))}
                    </div>
                </div>
