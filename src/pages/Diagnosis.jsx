...
const Diagnosis = () => {
    ...
    return (
        <div className="relative min-h-screen bg-[#0A0A0A] overflow-hidden">
            ...
            <section className="relative z-10 pt-32 md:pt-48 pb-16 px-6">
                ...
                >
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <a
                            ...
                            className="group relative px-8 py-4 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full font-bold text-lg transition-all duration-300 shadow-[0_10px_40px_rgba(37,211,102,0.3)] hover:shadow-[0_15px_50px_rgba(37,211,102,0.5)] hover:scale-105 flex items-center gap-3 w-full sm:w-auto justify-center"
                        >
                        ...
                        <button
                            ...
                            className="group relative px-8 py-4 bg-primary hover:bg-primary/90 text-background-dark rounded-full font-bold text-lg transition-all duration-300 shadow-[0_10px_40px_rgba(110,231,183,0.3)] hover:shadow-[0_15px_50px_rgba(110,231,183,0.5)] hover:scale-105 flex items-center gap-3 w-full sm:w-auto justify-center"
                        >
