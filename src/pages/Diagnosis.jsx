                ...
                >
                    <div className="relative p-1 rounded-[2.5rem] bg-gradient-to-br from-red-500/20 via-transparent to-red-500/10">
                        <div className="bg-[#0D0D0D] backdrop-blur-xl rounded-[2.4rem] p-8 md:p-12 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 md:items-center">
                                {/* Text Content */}
                                ...
                                <div className="relative z-10 flex flex-col sm:flex-row gap-4 justify-center items-center md:col-span-2">
                                    {/* WhatsApp Button */}
                                    <a
