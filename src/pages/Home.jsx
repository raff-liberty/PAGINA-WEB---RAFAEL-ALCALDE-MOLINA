                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-6xl">
                        {[
                            ...
                            <motion.div
                                ...
                                className="group relative bg-[#2a2a2a] backdrop-blur-md border border-white/50 p-6 rounded-xl hover:border-primary/50 transition-all duration-500 hover:bg-[#303030] flex flex-col shadow-[0_12px_48px_rgba(0,0,0,0.95)] overflow-hidden h-full"
                            >
                            ...
                            {content.map((item, idx) => (
                                ...
                                >
                                    <div className="relative group">
                                        ...
                                        <div className="relative grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 bg-[#2a2a2a] border border-white/60 p-6 md:p-12 rounded-2xl transition-all duration-300 items-start shadow-[0_12px_48px_rgba(0,0,0,0.95)] overflow-hidden group-hover:border-primary/50">
