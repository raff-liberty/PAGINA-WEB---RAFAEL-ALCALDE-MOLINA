...
const Services = () => {
    ...
    return (
        <div className="relative pt-32 pb-24 min-h-screen selection:bg-primary selection:text-black">
            <SEO
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <h1 className="font-display text-5xl md:text-7xl font-bold leading-tight mb-8 text-white tracking-tight">
                        Soluciones de <span className="text-primary italic">automatización</span> real
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-400 font-light leading-relaxed mb-10 italic">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Link to="/contact" className="bg-primary hover:bg-primary-hover text-gray-900 font-bold px-10 py-5 rounded-2xl transition-all transform hover:scale-105 shadow-[0_0_30px_rgba(110,231,183,0.3)]">
                ...
                <section className="mb-32">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="bg-[#252525] border border-white/20 p-8 md:p-12 rounded-[2.5rem] relative overflow-hidden shadow-[0_12px_48px_rgba(0,0,0,0.95)]">
                ...
                <section className="mb-32 relative">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="font-display text-3xl md:text-6xl font-bold text-white mb-6">
                            Nuestros <span className="text-primary italic">Productos Estrella</span>
                        </h2>
                    ...
                    <div className="relative max-w-6xl mx-auto px-4 md:px-0 overflow-hidden md:overflow-visible">
                        <AnimatePresence mode="wait" custom={direction}>
                            <motion.div
                                ...
                                className="bg-[#1a1a1a] border border-white/20 rounded-[3rem] p-8 md:p-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 shadow-[0_12px_48px_rgba(0,0,0,0.95)]"
                            >
                                {/* Slide Content Left */}
                                <div className="flex-1 text-center lg:text-left">
                                    ...
                                    <h3 className="text-white text-3xl md:text-5xl font-display font-bold mb-6 leading-tight">
                                        {starServices[activeService].title}
                                    </h3>
                                    <p className="text-gray-400 text-lg md:text-xl mb-10 leading-relaxed max-w-xl italic">
                                        "{starServices[activeService].desc}"
                                    </p>
                                    <Link
                                        to={starServices[activeService].link}
                                        className="inline-flex items-center gap-3 bg-primary text-black font-black px-10 py-5 rounded-2xl transition-all hover:scale-105 shadow-[0_0_30px_rgba(110,231,183,0.3)] group"
                                    >
                                ...
                                <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {starServices[activeService].subItems.map((item, idx) => (
                                        <div key={idx} className="bg-white/8 border border-white/20 p-6 rounded-2xl hover:bg-white/12 transition-colors shadow-lg">
                ...
                <section className="mb-32 bg-gradient-to-br from-[#1a1a1a] to-black border border-white/10 rounded-[3rem] p-8 md:p-20 relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20">
                        ...
                        <div className="bg-black/50 backdrop-blur-xl border border-white/10 p-10 rounded-[2rem] flex flex-col h-full">
                            <h4 className="text-white font-bold mb-6 uppercase tracking-widest text-xs opacity-50 text-center">Empieza el cambio hoy</h4>
                ...
                <section className="mb-32">
                    <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-16 text-center">
                        Casos Reales <br /> <span className="text-primary opacity-50 font-light text-2xl tracking-widest mt-2 block">CERO HUMO</span>
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {examples.map((ex, i) => (
                            <Link
                                key={i}
                                to={ex.link}
                                className="bg-[#1a1a1a] border border-white/20 p-8 md:p-12 rounded-[2rem] hover:bg-[#202020] transition-colors relative overflow-hidden group block text-left shadow-[0_8px_32px_rgba(0,0,0,0.9)]"
                            >
                ...
                <section className="mb-32 max-w-4xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, i) => (
                            <div key={i} className="bg-[#1f1f1f] border border-white/20 p-8 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.9)]">
                ...
                {/* FINAL CTA */}
                <section className="relative overflow-hidden rounded-[3.5rem] bg-primary p-12 md:p-24 text-center">
                    <div className="absolute inset-0 bg-[url('/noise.png')] opacity-20 contrast-150"></div>
                    <div className="relative z-10">
                        <h2 className="font-display text-4xl md:text-6xl font-black text-gray-900 mb-8 uppercase">
                            Empieza con una <br /> auditoría gratuita
                        </h2>
                        <p className="text-gray-900/70 text-xl md:text-2xl font-medium max-w-2xl mx-auto mb-12">
                        ...
                        <Link
                            to="/contact"
                            className="inline-flex items-center gap-4 bg-gray-900 text-primary font-black text-2xl px-12 py-6 rounded-2xl hover:bg-black transition-all transform hover:scale-105 shadow-2xl"
                        >
                            SOLICITAR AUDITORÍA <ArrowRight className="w-8 h-8" />
                        </Link>
                    </div>
                </section>
            </div>
